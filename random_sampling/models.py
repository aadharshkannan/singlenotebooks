"""Core immutable models for the random Agent 365 sampling pipeline."""
...
class SamplePolicy:
    """Versioned policy for deterministic stratified random samples."""

    margin: float = 0.10
    confidence: float = 0.95
    seed: int = 13
    version: str = "random-session-stratified-v1"
